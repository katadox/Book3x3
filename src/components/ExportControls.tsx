  ...
  return (
    <div className="space-y-5 rounded-2xl border border-slate-800 bg-slate-900/90 p-5 shadow-2xl backdrop-blur-xl">
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-1 rounded-xl bg-slate-950 p-1 border border-slate-800">
            <button
              ...
              className={`rounded-lg py-1.5 text-xs font-bold active:scale-[0.96] transition-all duration-150 ${
      ...
      <button
        ...
        className={`flex w-full items-center justify-center gap-3 rounded-xl py-3.5 px-4 text-sm font-extrabold transition-all duration-150 shadow-glow ${
          !isExporting
            ? 'bg-gradient-to-r from-amber-500 via-amber-600 to-amber-700 text-slate-950 hover:shadow-glow-lg hover:scale-[1.01] active:scale-[0.98]'
      ...
      <div className="flex gap-2">
        <button
          onClick={handleShare}
          className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-800/80 py-2.5 px-4 text-xs font-semibold text-slate-200 hover:border-amber-500/40 hover:bg-slate-700 active:scale-[0.97] transition-all duration-150"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 rounded-xl border border-slate-700 bg-slate-800/80 px-4 py-2.5 text-xs font-semibold text-slate-200 hover:border-amber-500/40 hover:bg-slate-700 active:scale-[0.97] transition-all duration-150"
        >
